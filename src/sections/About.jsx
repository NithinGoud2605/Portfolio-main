        ...
        <div className="col-span-3 xl:row-span-3">
          <div className="grid-container">
            ...
            <div>
              ...
              Currently pursuing my Master of Engineering in Computer Science at the University of Cincinnati, I am passionate about becoming a Full Stack Developer with expertise in both frontend and backend development. My focus is on developing dynamic and responsive web applications that provide seamless user experiences.
              </p>
